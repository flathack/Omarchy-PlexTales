...
class QmlContractTests(unittest.TestCase):
    def test_native_panel_contract(self):
        ...
        self.assertIn('moduleName: "io.github.flathack.plextales"', QML)
    ...
    def test_missing_covers_use_theme_aware_placeholder(self):
        ...
        self.assertIn("source: root.book24Url", QML)
    ...
    def test_book_assets_scale_across_player_ui(self):
        self.assertIn('Qt.resolvedUrl("assets/book.svg")', QML)
        self.assertIn('Qt.resolvedUrl("assets/book.svg")', QML)
    ...
    def test_omarchy_theme_roles_update_the_popup(self):
        ...
        self.assertIn('tooltipText: "Back 30 seconds"', QML)
        self.assertIn('tooltipText: "Forward 30 seconds"', QML)
    ...
    def test_keyboard_help_is_available_from_button_and_f1(self):
        ...
        self.assertIn('text: root.helpVisible || !root.plexConnected ? "PlexTales"', QML)
